    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/appointments/my").authenticated()
                        .requestMatchers(HttpMethod.GET, "/appointments/**").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/appointments/*/cancel").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/appointments/*/reschedule").authenticated()
                        .requestMatchers(HttpMethod.GET, "/appointments", "/appointments/stats").hasRole("ADMIN")
